 ...
 * @author dona
 */
@WebServlet(urlPatterns = {"/username_email_valid"})
public class username_email_valid extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(username_email_valid.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
