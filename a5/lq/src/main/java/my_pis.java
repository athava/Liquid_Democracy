    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (param.matches("expired")) {
                ...
                out.println("<table class=\"table\">");
                out.println("<tr><th>Title</th><th>Description</th><th>Category</th><th>Expiration</th><th></th><th></th><th></th></tr>");
                ...
                while (i < pis.size()) {
                    ...
                    if (pi.getStatus() == 0) {
                        ...
                        out.println("<tr><td onclick=\"pi_page(" + pis.get(i).getId() + ")\">" + pi.getTitle() + "</td>"
                        ...
                        if (pi.getExpires() == null) {
                            ...
                            out.println("<td>" + exp + "</td>"
                                    + "<td><a onclick=\"delete_inititative(" + pi.getId() + ")\"><span class=\"glyphicon glyphicon-trash\"></span>Delete</a></td>"
